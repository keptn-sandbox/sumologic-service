...
func TestPodtatoheadEvaluation(t *testing.T) {
	...
	additionalResources := []struct {
		...
		{FilePath: "../data/podtatohead.sli.yaml", ResourceName: "sumologic/sli.yaml"},
	...
	t.Run("Configure Sumologic", func(t *testing.T) {
		...
		// wait until sumologic is configured correctly ...
